    ...
    const data = [
        ...
        },
        {
            ...
            desc: "Работает в отделе кадров строительной компании. " +
                "В начале августа прошла курс «Специалист отдела кадров». " +
                "В планах - обучение на тему «Управление персоналом». " +
                "\n-Знаний много никогда не бывает, - утверждает Юлия.",
            featured: true,
        },
        {
            id: 3,
            ...
            desc: "Став директором предприятия, решила что должна знать " +
                ...
                "За плечами 2 курса -" +
                " «Специалист отдела кадров» и «Бухгалтерский учёт. Налогооложение» ",
            featured: true,
        },
    ];
