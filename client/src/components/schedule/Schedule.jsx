...
const courses = [
    ...
    },
    {
        course: {
            ...
            hours: '7 ак.ч.',
            discount: 'Скидка 10%',
            proviso3: '*Скидка 10% при оплате полной стоимости курса одним платежом',
            program: 'Программа обучения',
            order: 'Записаться',
            courseProgram: [
    ...
    },
    {
        course: {
            ...
            order: 'Записаться',
            courseProgram: [
                '1) Делаем корректировки в учете в соответствии с изменениями законодательства',
                '2) Уставный капитал',
                '3) Учётная политика',
                '4) Структура юрлица и бенефициары',
                '5) 1-ОПП, 10-ОПП, 20-ОПП',
                '6) Переоценка запасов',
                '7) Ответственное хранение товара',
                '8) Признание расходов на маркетинговые и другие подобные услуги',
                '9) Списание горючего',
                '10) Новое у ФОП в т. ч. возвратная финансовая помощь',
                '11) Учёт целевого финансирования',
                '12) Продажа основных средств и других необоротных активов',
                '13) Исполнительные листы',
                '14) Ошибки в товаро-транспортной накладной и их последствия',
                '15) НДС',
                '16) Отпуск',
                '17) Электронная трудовая книжка',
                '18) Увольнение после 10.06.2021',
            ],
            makeStyles: {
                toolbar1: {
                    backgroundColor: '#ffcf33',
