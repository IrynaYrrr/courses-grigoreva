...
const courses = [
    ...
    },
    {
        course: {
            ...
            order: 'Записаться',
            courseProgram: [
                'Делаем корректировки в учете в соответствии с изменениями законодательства',
                'Уставный капитал',
                'Учётная политика',
                'Структура юрлица и бенефициары',
                '1-ОПП, 10-ОПП, 20-ОПП',
                'Переоценка запасов',
                'Ответственное хранение товара',
                'Признание расходов на маркетинговые и другие подобные услуги',
                'Списание горючего',
                'Новое у ФОП в т. ч. возвратная финансовая помощь',
                'Учёт целевого финансирования',
                'Продажа основных средств и других необоротных активов',
                'Исполнительные листы',
                'Ошибки в товаро-транспортной накладной и их последствия',
                'НДС',
                'Отпуск',
                'Электронная трудовая книжка',
                'Увольнение после 10.06 2021',
            ],
            makeStyles: {
                toolbar1: {
                    backgroundColor: "#ffcf33",
